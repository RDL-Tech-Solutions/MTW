...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // Para web, usar popup do Supabase
      // Nota: Isso requer configuração do Supabase no admin panel
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {socialLoading.facebook ? 'Carregando...' : 'Continuar com Facebook'}
              </Button>
            </div>
