...
class SyncConfig {
  ...
  static async upsert(configData) {
    const {
      ...
      aliexpress_enabled,
      shopee_auto_publish,
      mercadolivre_auto_publish,
      amazon_auto_publish,
      aliexpress_auto_publish,
      keywords,
    ...
    if (existing && existing.id) {
      ...
      const { data, error } = await supabase
        ...
        .update({
          ...
          shopee_auto_publish: shopee_auto_publish || false,
          mercadolivre_auto_publish: mercadolivre_auto_publish || false,
          amazon_auto_publish: amazon_auto_publish || false,
          aliexpress_auto_publish: aliexpress_auto_publish || false,
          keywords,
          min_discount_percentage,
          categories,
          cron_interval_minutes,
