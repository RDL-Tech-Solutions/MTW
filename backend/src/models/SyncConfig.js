...
class SyncConfig {
  ...
  static async upsert(configData) {
    ...
    const payload = {
      ...
      pichau_enabled: Boolean(configData.pichau_enabled),
      ...
      pichau_auto_publish: Boolean(configData.pichau_auto_publish),
      ...
      pichau_shorten_link: Boolean(configData.pichau_shorten_link),
